...
<body>
	<?php if ($language === 'de'): ?>
		...
		<p class="text">Wenn Sie diese Seite sehen, dann bedeutet dies, dass die neue Site erfolgreich eingerichtet wurde.
			Sie können jetzt Ihren Web-Inhalt hinzufügen, diese Platzhalter-Seite<sup><a href="#footnote-1">1</a></sup>
		...
		<p class="text">
			...
			MySQL-Version:
			<samp><?php $myv = strip_tags(htmlentities($_SERVER['MYSQL_VERSION'], ENT_QUOTES, 'UTF-8'));
			echo ($myv !== '' ? $myv : '-'); ?></samp><br>
		</p>
	...
	<?php elseif ($language == 'en'): ?>
		...
		<p class="text">If you can see this page, your new site was set up successfully. Now, web content can be added and
			this placeholder page<sup><a href="#footnote-1">1</a></sup> should be replaced or deleted.</p>
		<p class="text">
			Server software:
			<samp><?php echo strip_tags(htmlentities($_SERVER['SERVER_SOFTWARE'], ENT_QUOTES, 'UTF-8')); ?></samp><br>
			Site name:
